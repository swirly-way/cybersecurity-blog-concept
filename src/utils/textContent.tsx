...
export const boxContentA: BoxContent[] = [
  {
    value: "a",
    title: "Encryption",
...
export const boxContentB: BoxContent[] = [
  {
    value: "a",
    title: "Use HTTPS: ",
...
export const boxContentC: BoxContent[] = [
  {
    value: "a",
    title: "OWASP:",
...
export const boxContentD: BoxContent[] = [
  {
    value: "a",
...
export const boxContentE: BoxContent[] = [
  {
    value: "a",
...
export const boxContentF: BoxContent[] = [
  {
    value: "a",
